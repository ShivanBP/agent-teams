...
WAKE_HEADER = (
    ...
    ".../blob/<sha>/<path>, never blob/main; the summary and decisions still go in the body. "
    "For images, binaries, or a repo with no remote, put [attach: /abs/path] alone on a line "
    "in your reply; it uploads and posts as a link (roots ~/Projects and the logs dir, 4 files "
    "max, 10MB each).\n"
